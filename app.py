...
C_pickle = bz2.BZ2File('best_classification_model.pkl', 'rb')
R_pickle = bz2.BZ2File('best_regressor_model.pkl', 'rb')
    ...
    if request.method == 'POST':
        try:
            ...
            if prediction == 0:
                ...
                text = 'Your Forest is in Danger!, Please contact the local rangers'
        ...
        return render_template('index.html', prediction_text1="Check your Input again")
